...
public class RollerCoaster {
	...
	public static void main(String[] args) {
		...
		String heightToRide = JOptionPane.showInputDialog("enter you height");
		...
		if( heightAsInt < 42 ) { 
			System.out.println("You must be at least 42 inches tall to ride the roller coaster pal!");
		}
		if( heightAsInt >= 48 ) { 
			System.out.println("You can ride the coaster alone!");
		}
